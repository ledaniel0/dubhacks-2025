            ...
            return (
              ...
              >
                ...
                {onPhotoClick && (
                  <div
                    className={cn(
                      "absolute top-3 left-3 w-8 h-8 rounded-full bg-black/30 border border-white/50 backdrop-blur-sm transition-all duration-300 flex items-center justify-center scale-0 group-hover:scale-100",
                    )}
                    onClick={(e) => {
                      e.stopPropagation()
                      onPhotoClick(photo)
